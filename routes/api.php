...
Route::group(["namespace" => "Api\Auth"], function () {
    ...
    Route::post("signUpPhoneNumber", "ApiAuthController@signUpPhoneNumber")->name("signUpPhoneNumber");
    Route::post("verifyOtp", "ApiAuthController@verifyOtp")->name("verifyOtp");
...
Route::group(["middleware" => ["auth:api", "jwt.auth"], "namespace" => "Api"], function () {
    ...
    Route::get("order-progress/{order_id}", "CheckOutController@orderProgress")->name("order-progress");
