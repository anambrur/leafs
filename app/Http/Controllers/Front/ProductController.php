                        ...
                        $output .= ' 
                          <li>
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="' . url('product/' . $product->slug) . '">
                                        <img class="img-responsive" alt="product" src="' . SM::sm_get_the_src($attribute_image, 186, 262) . '" />
                                    </a>
                        ...
                        $output .= ' 
                          <li>
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="' . url('product/' . $product->slug) . '">
                                        <img class="img-responsive" alt="product" src="' . SM::sm_get_the_src($product->image, 186, 262) . '" />
                                    </a>
