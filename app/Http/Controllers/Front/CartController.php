...
class CartController extends Controller
{
    ...
    // {
    //     $items = Cart::instance('cart')->content();
    //     $totalItems = Cart::instance('cart')->count();
    //     $subTotal = SM::currency_price_value(Cart::instance('cart')->subTotal());

    //     $html = '<div id="aitcg-control-panel" style="display: block;">';
    //     $html .= '<button class="bttn-close hideButton" id="ShowDivButton">';
    //     $html .= '<i class="fa fa-times"></i> Close';
    //     $html .= '</button>';
    //     $html .= '<h1 class="popup_top_total"><i class="fa fa-shopping-bag"></i> ' . $totalItems . ' ITEMS</h1>';
    //     $html .= '<h4>Trusted Online Shopping Site</h4>';
    //     $html .= '<div class="add-product-area right_cart_html" style="max-height: 480px; overflow-y: scroll">';
    ...
    //             $html .= '</div>';
    //             $html .= '<img src="' . SM::sm_get_the_src($item->options->image, 103, 125) . '" alt="' . $item->name . '">';
    ...
    //                 $size = Attribute::find($item->size);
    //                 $color = Attribute::find($item->color);
    //                 $html .= '<div class="pro-head">';
    //                 $html .= '<h3>Size: ' . ($size ? $size->title : '') . '</h3>';
    //                 $html .= '<small>Color : ' . ($color ? $color->title : '') . ' <button style="background-color: ' . ($color ? $color->color_code : '') . ';width: 20px;height: 20px; border-radius: 50%;"></button></small>';
    //                 $html .= '</div>';
    //             }
    //             $html .= '</div><hr>';
    //         }
    ...
    //     $html .= '</div>';  // Close .right_cart_html div
    //     $html .= '<div class="add-btn-area">';
    //     $html .= '<h5 class="sub_total">' . $subTotal . '</h5>';
    //     $html .= '<a class="btn btn-add-place" href="' . url('cart') . '">Place Order</a>';
    //     $html .= '</div>';
    //     $html .= '</div>';  // Close #aitcg-control-panel div
