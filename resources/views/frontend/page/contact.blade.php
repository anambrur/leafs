...
<div class="row">
        <div class="col-md-12">
            ...
            <div class="blog-banner " style="">
                    <div class="blog-banner-contents">
                            <h1>Contact Us</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="box-card">
                                ...
                                <p class="whatsApp"><strong>What's App</strong></p>
                                <p>{{$mobile}}</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="contact-form-box">
                            <!--<p>Please feel free to contact with us if you would like more information or any help. Please contact with us directly with products details, so that we are able to respond promptly with the information you require.</p>-->
                            <h3> Get In Touch </h3>
