...
<head>
    ...
    $seo_title = stripslashes(isset($seo_title) && SM::sm_string($seo_title) ? $seo_title : SM::get_setting_value('seo_title'));
    $meta_key = stripslashes(isset($meta_key) && SM::sm_string($meta_key) ? $meta_key : SM::get_setting_value('site_meta_keywords'));
    $meta_description = stripslashes(isset($meta_description) && SM::sm_string($meta_description) ? $meta_description : SM::get_setting_value('site_meta_description'));
    $image = isset($image) && SM::sm_string($image) ? $image : asset(SM::sm_get_the_src(SM::get_setting_value('site_screenshot')));
    ...
    <!-- Google Fonts -->
    <link
        href="https://fonts.googleapis.com/css?family=Raleway:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&amp;subset=latin-ext"
        rel="stylesheet">
    <link
        href="https://fonts.googleapis.com/css?family=Poppins:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&amp;subset=devanagari,latin-ext"
        rel="stylesheet">
    <link
        href="https://fonts.googleapis.com/css?family=Catamaran:200,300,400,500,600,700,800,900&amp;subset=latin-ext,tamil"
        rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Fjalla+One" rel="stylesheet">
    <?php
    SM::smGetSystemFrontEndCss(['bootstrap.min', 'font-awesome.min', 'swiper.min', 'animate.min', 'magnific-popup.min', 'video-js']);
    ?>
    @yield('header_style')
    <?php
    ...
    SM::smGetSystemFrontEndJs(['jquery-3.2.1.min', 'state']);
...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6">
                    <ul class="header-top-phone">
                        ...
                        ?>
                        <li><i class="fa fa-map-marker"></i> {{ trim(stripslashes($address)) }}, {{ $country }}
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6 col-sm-6">
    ...
    <!--footer End-->
    <?php
    SM::smGetSystemFrontEndJs(['bootstrap.min', 'modernizr', 'swiper.jquery.min', 'mixitup.min', 'jquery.magnific-popup.min', 'wow.min', 'jquery.appear.min', 'video']);
    SM::smGetSystemFrontEndJs(['https://unpkg.com/sweetalert/dist/sweetalert.min.js'], 1);
    ?>
    @yield('footer_script')
    <?php
