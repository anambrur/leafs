...
<article class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
    ...
    <div class="jarviswidget" id="wid-add-attribute-main" data-widget-editbutton="false" data-widget-deletebutton="false">
        <header>
...
?>
@include('nptl-admin/common/common/image_form', ['header_name' => 'Attributetitle', 'image' => $image])
@include('nptl-admin/common/common/meta_info', ['header_name' => 'Attributetitle', 'width' => 'col-lg-12'])
